...
CONDEMNED_REVOLUTIONARY_AUTHORS: List[str] = [
    ...
    "Leon Trotsky",
    "Nikolai Kaslov",
    # Bolshevik repressions — executed or gulag-killed writers
    "Isaac Babel",
    "Osip Mandelstam",
    "Nikolai Bukharin",
    "Lev Kamenev",
    ...
    "Peter Kropotkin",
    "Petr Kropotkin",
    # Eastern Europe — writers condemned by their own states
    "Milovan Djilas",
    "Václav Havel",
    "Vaclav Havel",
    "György Lukács",
    "György Lukacs",
    # Latin America & the Caribbean — exiled / killed for their writing
    "José Martí",
    "Jose Marti",
    ...
    "José Rizal",
    "Andrés Bonifacio",
    # The Philippines' colonial canon
    "Marcelo H. del Pilar",
    "Graciano López Jaena",
    "Graciano Lopez Jaena",
    # Middle East / North Africa — banned, exiled or killed by the state
    "Sayyid Qutb",
    "Abdullah al-Qasemi",
    "Abdellatif Laâbi",
    "Nawal El Saadawi",
    ...
    "Hassan al-Banna",
    "Hassan al Banna",
    # Iran / South Asia — books suppressed
    "Sadeq Hedayat",
    "Sadegh Hedayat",
    "Ahmad Kasravi",
    "Kim Chi-ha",
    "Kim Chiha",
    "Kim Chi Ha",
    # South Africa — wider apartheid-ban canon (previously listed figureheads)
    "Breyten Breytenbach",
    "Albie Sachs",
    "Ahmed Kathrada",
    "Walter Sisulu",
    ...
    "Denis Goldberg",
    "Mac Maharaj",
    # Namibia / Southern Africa liberation canon
    "Sam Nujoma",
